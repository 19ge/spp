...
export default class TransAcc extends Component {
    state={
        num:"",
        safepwd:"",
        selectedTab: '2',
    ...
    async btntrans(){
        ...
        const result=await Shop.trans({tr_account:account,tr_tel:tel,tr_num:num,us_safe_pwd:safepwd});
        // if(account===''){
    ...
    render(){  
        const navBarProps = {
            ...
            rightContent:"转账记录",
            rightFunc(){
		        dispatch(routerRedux.push('/Transrecord'));
            }
        }
            ...
            <div className={styles.App}>
                ...
                <List>
                    <InputItem        
                        ...
                        placeholder="对方账号"
                        ref='num'
                        onChange={this.inputacc.bind(this)}
                    >对方账号</InputItem>
                    <InputItem        
                        clear
                        placeholder="对方手机号"
                ...
                <div className={styles.account}>
                    ...
                    <Button type="primary" onClick={()=>this.btntrans()}>确认转账</Button><WhiteSpace />
                </div>                   
                    <div>
                    </div>            
            </div>
